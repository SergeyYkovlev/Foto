...
#ifndef COLLECTIONVIEWTOOLS_SWIFT_H
#define COLLECTIONVIEWTOOLS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CollectionViewTools",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19CollectionViewTools21CollectionViewManager")
...
@interface CollectionViewManager (SWIFT_EXTENSION(CollectionViewTools)) <UICollectionViewDataSourcePrefetching>
...
@interface CollectionViewManager (SWIFT_EXTENSION(CollectionViewTools)) <UICollectionViewDelegateFlowLayout>
...
@interface CollectionViewManager (SWIFT_EXTENSION(CollectionViewTools)) <UICollectionViewDataSource>
...
@interface CollectionViewManager (SWIFT_EXTENSION(CollectionViewTools)) <UICollectionViewDelegate>
...
@interface CollectionViewManager (SWIFT_EXTENSION(CollectionViewTools)) <UIScrollViewDelegate>
